...
public class MaterialActivity_si extends AppCompatActivity {
    ...
    private MaterialDatabaseHelper_si dbHelper;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.si_activity_material); // Use same layout or create a Sinhala version if needed

        materialContainer = findViewById(R.id.materialContainer);
        dbHelper = new MaterialDatabaseHelper_si(this);
    ...
    private void loadMaterials() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM " + MaterialDatabaseHelper_si.TABLE_NAME, null);
