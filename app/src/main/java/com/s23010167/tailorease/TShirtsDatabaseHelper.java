...
public class TShirtsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 2; // Bumped for schema upgrades
    ...
    public static final String COL_DESCRIPTION = "description"; // Description text
    ...
    public static final String COL_PRICE = "price";           // Price text
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Insert initial data (both T-Shirts and Shirts) with measurements and prices
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Drop table if exists and recreate (simple upgrade strategy)
